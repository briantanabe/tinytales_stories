...
parser.add_argument('--input_txt', type=str,  help='txt')

parser.add_argument('--input_json', type=str,  help='json')

parser.add_argument('--output_location', type=str,  help='output')
...
f.flush()
f.close()
# print(f"Done creating schedule for {OUTPUT_LOCATION}.")
